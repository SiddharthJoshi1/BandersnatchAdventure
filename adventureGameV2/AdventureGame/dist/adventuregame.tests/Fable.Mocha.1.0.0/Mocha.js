...
var _Async = require("../fable-library.2.4.15/Async");

var _AsyncBuilder = require("../fable-library.2.4.15/AsyncBuilder");
...
function TestCase$reflection() {
  return (0, _Reflection.union)("Fable.Mocha.TestCase", [], TestCase, () => [["SyncTest", [_Reflection.string, (0, _Reflection.lambda)(_Reflection.unit, _Reflection.unit)]], ["AsyncTest", [_Reflection.string, (0, _Reflection.lambda)(_Reflection.unit, (0, _Reflection.type)("Microsoft.FSharp.Control.FSharpAsync`1", [_Reflection.unit]))]]]);
}
...
function TestModule$reflection() {
  return (0, _Reflection.union)("Fable.Mocha.TestModule", [], TestModule, () => [["TestModule", [_Reflection.string, (0, _Reflection.list)(TestCase$reflection())]]]);
}
