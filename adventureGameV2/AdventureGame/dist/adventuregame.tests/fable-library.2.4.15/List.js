...
function pairwise(xs$$146) {
  const inner = function inner($xs$$147$$287, $acc$$27$$288, $x1$$1$$289) {
    inner: while (true) {
      ...
      if (xs$$147.tail != null) {
        ...
        (0, _Array.addInPlace)([x1$$1, xs$$147.head], copyOfStruct);
  ...
  switch ($target$$290) {
    ...
    case 1:
      {
        const acc$$28 = [];
        (0, _Array.addInPlace)([x1$$2, x2$$2], acc$$28);
        const clo1 = (0, _Util.partialApply)(2, inner, [xs$$149]);
...
function splitInto(chunks, source$$1) {
  ...
  let xs$$150;
  let array$$5;
  array$$5 = (0, _Array.ofList)(source$$1, Array);
  xs$$150 = (0, _Array.splitInto)(chunks, array$$5);
...
function transpose(lists$$1) {
  let xs$$154;
  let source$$3;
  source$$3 = (0, _Seq.transpose)(lists$$1);
  xs$$154 = (0, _Seq.map)(ofSeq, source$$3);
  return ofSeq(xs$$154);
}