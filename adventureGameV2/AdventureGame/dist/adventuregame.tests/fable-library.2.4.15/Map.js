...
FSharpMap.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    ...
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3703[0]));
    res$$3 = combineHash(res$$3, (0, _Util.structuralHash)(activePatternResult3703[1]));
  }
...
function groupBy(projection, xs, comparer$$24) {
  ...
  (0, _Seq.iterate)(function (v$$31) {
    ...
    if (dict.has(key)) {
      (0, _Array.addInPlace)(v$$31, dict.get(key));
    } else {
