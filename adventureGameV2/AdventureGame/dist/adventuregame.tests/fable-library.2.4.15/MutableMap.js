...
function MutableMap$00602$$set_Item$$5BDDA1(this$$$7, k$$3, v) {
  ...
  switch ($target$$20) {
    ...
    case 1:
      {
        if (matchValue$$3[0]) {
          const value = (0, _Array.addInPlace)([k$$3, v], (0, _Util.getItemFromDict)(this$$$7.hashMap, matchValue$$3[1]));
          void null;
        } else {
...
function MutableMap$00602$$Add$$5BDDA1(this$$$8, k$$4, v$$1) {
  ...
  switch ($target$$24) {
    ...
    case 1:
      {
        if (matchValue$$4[0]) {
          const value$$1 = (0, _Array.addInPlace)([k$$4, v$$1], (0, _Util.getItemFromDict)(this$$$8.hashMap, matchValue$$4[1]));
          void null;
        } else {
